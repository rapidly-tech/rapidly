...
description: A skill to add a new entry in the section "Backend Development" of the Rapidly Handbook. Those entries are there to explain concepts, tooling and best practices related to backend development, and are meant to be read by Rapidly developers.
user-invocable: true
...
This skill explains the process to add a new entry in the section "Backend Development" of the Rapidly Handbook. Those entries are there to explain concepts, tooling and best practices related to backend development, and are meant to be read by Rapidly developers.
...
Once you have a draft of the entry, ask for feedback from the user. If you have any doubts about the content, ask for clarification. You can also ask for feedback on the structure and the clarity of the entry. The goal is to make sure that the entry is accurate, clear, and useful for Rapidly developers.
