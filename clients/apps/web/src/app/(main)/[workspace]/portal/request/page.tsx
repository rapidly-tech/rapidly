...
/** Customer portal access request page where users enter their email to receive a session token. */
export default async function Page(props: {
  ...
  return <RequestPage workspace={workspace} email={searchParams.email} />
}
