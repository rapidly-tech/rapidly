export const metadata = {
  title: 'Acceptable Use | Rapidly Docs',
  description: 'Acceptable products and use policies',
}

# Acceptable Use

<p className="docs-lead">Acceptable products and use policies</p>

We focus exclusively on digital content and file shares. Therefore we cannot support
...
## Acceptable Content & Businesses

- Digital content and file shares: Templates, eBooks, PDFs, code, icons, fonts, design assets, photos, videos, audio etc
- Premium content & access: courses and content delivered via file sharing.

**General rule of acceptable services**

Digital content or files that can be fulfilled by...

1. Rapidly on your behalf (File Downloads, secure file sharing links, etc)
2. Your site/service using our APIs to grant immediate access to digital content
   for customers with a one-time purchase
...
Don't hesitate to [reach out to us](/docs/support) in advance in case you're unsure if your use case would be approved.
...
- Physical goods of any kind. Including services offering or requiring fulfilment via physical delivery or human services.
- Human services, e.g marketing, design, web development and consulting in general.
- Donations or charity, i.e price is greater than product value or there is no exchange at all (pure money transfer).
...
Generally, no. It's a high risk category.
Sellers could withdraw funds and never deliver the service or not as promised.
Causing consumers to demand refunds or dispute the sale at a later
date.
