export const metadata = {
  title: 'File Sharing | Rapidly Docs',
  description:
    'Securely share files peer-to-peer with end-to-end encryption \u2014 no server storage, no size limits',
}

# File Sharing

<p className="docs-lead">
  Securely share files peer-to-peer with end-to-end encryption — no server
  storage, no size limits
</p>
...
<Note>
  The encryption key lives in the URL fragment (`#`), which browsers never
  transmit to the server. This ensures true zero-knowledge architecture.
</Note>
