export const metadata = {
  title: 'Customer Management | Rapidly Docs',
  description: 'Get insights on your customers and sales',
}

# Customer Management

<p className="docs-lead">Get insights on your customers and sales</p>
...
It can be set through the dashboard or through the [API](/docs/api-reference/customers/update#body-metadata).
