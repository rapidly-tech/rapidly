export const metadata = {
  title: 'Setup Webhooks | Rapidly Docs',
...
<p className="docs-lead">
  Get notifications asynchronously when events occur instead of
</p>
...
Use a free share to test file share access and trigger
...
&rarr;](/docs/integrate/webhooks/delivery)
