export const metadata = {
  title: 'Payouts | Rapidly Docs',
  description: 'Easily withdraw money from your Rapidly account at any time',
}

# Payouts

<p className="docs-lead">
  Easily withdraw money from your Rapidly account at any time
</p>
...
Your customers get an invoice from Rapidly. Thus, for your accounting, you need to issue an invoice to Rapidly for the amount we paid out to you. To ease this process, we can automatically generate a **reverse invoice** for you, detailing the sales processed on your behalf, minus our fees.

You can generate them from the **Payouts** page under **Finance** in your Rapidly dashboard. Click on the ellipsis next to the payout you want to generate a reverse invoice for, and select **Download invoice**.
...
- Customize the invoice number. By default, we generate one like `RAPIDLY-0001`, but you can change it to your own format and sequence.
...
<AccordionGroup>
  ...
  <Accordion title="Can I use my personal bank account to receive payouts?">
    For individual accounts, yes. For business accounts, you will need a
