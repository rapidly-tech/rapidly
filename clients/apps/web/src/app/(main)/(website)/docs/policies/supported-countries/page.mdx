...
<AccordionGroup>
  <Accordion title="Can I use Rapidly in countries (e.g. India) where Stripe is invite-only?">
    ...
    Yes, any individual or company operating in our [supported countries](/docs/policies/supported-countries) can receive payouts from Rapidly even if Stripe standalone is invite-only there.
