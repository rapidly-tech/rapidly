...
We need to make sure that businesses using Rapidly comply with our [acceptable products & use](/policies/acceptable-use) policies. Combined with continuously monitoring, reviewing and preventing fraud, unacceptable use, bad actors and high risk accounts.
...
We need to perform this review to ensure compliance with our [acceptable products & use](/policies/acceptable-use) policy. Combined with meeting our own KYC/AML requirements as a file-sharing platform.
...
For merchants who violate our [acceptable use policies](/policies/acceptable-use) (and don't have high chargeback rates):
...
- Ensure compliance with our [acceptable use policies](/policies/acceptable-use)
