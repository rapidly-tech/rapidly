export const metadata = {
  title: 'Customer Portal | Rapidly Docs',
  description:
    'A self-service portal where customers view file share sessions, downloads, and payments',
}

# Customer Portal

<p className="docs-lead">
  A self-service portal where customers view file share sessions, downloads, and
  payments
</p>
...
async function run() {
  const response = await fetch(
    'https://api.rapidly.tech/api/customer-sessions/',
    {
      method: 'POST',
      headers: {
