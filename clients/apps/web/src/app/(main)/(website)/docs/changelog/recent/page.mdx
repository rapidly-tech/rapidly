export const metadata = {
  title: 'Product Updates | Rapidly Docs',
  description:
    'Stay up to date with the latest changes and improvements to Rapidly.',
}
...
- See the [Fees policy](/docs/policies/fees) for the full breakdown and worked example
