...
export default function Layout({ children }: PropsWithChildren) {
  return (
    <div className="rp-page-bg relative flex min-h-dvh flex-col overflow-x-hidden px-0 md:w-full md:items-center md:px-4">
      <a
        href="#main-content"
...
const NavLink = ({
  ...
  return (
    <Link
      ...
      prefetch
      className={twMerge(
        'rp-text-secondary hover:rp-text-primary -m-2 flex min-h-[44px] items-center gap-x-2 p-2 transition-colors',
