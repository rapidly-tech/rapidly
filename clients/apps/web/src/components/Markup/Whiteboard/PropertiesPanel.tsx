...
import type { ElementStore } from '@/utils/markup/element-store'
import { isValidHex, normaliseHex } from '@/utils/markup/hex-color'
import {
  applyToSelection,
  CONVERTIBLE_TYPES,
  FILL_PALETTE,
  ...
  TEXT_ALIGNMENTS,
  type SharedValue,
} from '@/utils/markup/properties'
import {
  addRecentColor,
  getRecentColors,
  subscribeRecentColors,
} from '@/utils/markup/recent-colors'
import type { SelectionState } from '@/utils/markup/selection'
import {
  degToRad,
  formatDimension,
  normaliseDegrees,
  parseDimension,
  radToDeg,
} from '@/utils/markup/transform-input'
