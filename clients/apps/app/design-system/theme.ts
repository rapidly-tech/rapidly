/**
 * Core theme configuration for the Rapidly mobile design system.
 *
 * Aggregates color tokens, spacing scale, border radii, dimension tokens,
 * and variant definitions (text + button) into a unified Shopify Restyle
 * theme. Every visual primitive in the app resolves its styles against
 * these tokens.
 */
