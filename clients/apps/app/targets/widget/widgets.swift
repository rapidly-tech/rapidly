...
struct Provider: AppIntentTimelineProvider {
    ...
    func snapshot(for configuration: ConfigurationAppIntent, in context: Context) async -> SimpleEntry {
        let defaults = UserDefaults(suiteName: "group.com.rapidly-tech.Rapidly")
    ...
    private func checkIfUnauthorized(apiToken: String?, organizationId: String?) async -> Bool {
        ...
        var components = URLComponents(string: "https://api.rapidly.tech/v1/metrics/")!
...
struct widgetEntryView : View {
    ...
    private var largeWidgetView: some View {
        ...
        let logoImageName = colorScheme == .dark ? "RapidlyLogoWhite" : "RapidlyLogoBlack"
...
struct LockScreenWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Rapidly Lock Screen")
