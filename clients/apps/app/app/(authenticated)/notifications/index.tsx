...
import {
  Notification as RapidlyNotification,
...
const groupNotificationsByDate = (notifications: RapidlyNotification[]) => {
  if (!notifications?.length) return []

  const result: (RapidlyNotification | string)[] = []
  ...
  return (
    <React.Fragment>
      ...
      <FlashList
        ...
        renderItem={({ item }: { item: RapidlyNotification | string }) => {
