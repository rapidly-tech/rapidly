...
/** Currency-aware numeric input with locale formatting and decimal handling. */
// ── Main Component ──
...
const MoneyInput = (props: Props) => {
  ...
  return (
    <Input
      ...
      name={name}
      className={twMerge(
        'block w-full px-4 pl-14 text-base font-normal placeholder:text-slate-400 dark:placeholder:text-slate-500',
        props.className ?? '',
      )}
      value={internalValue}
      onChange={onChange}
