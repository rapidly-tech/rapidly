...
/** Page navigation control with numbered buttons and previous/next arrows. */
const Paginator = ({
  totalCount,
  pageSize,
  currentPage,
    ...
    >
      ...
      {paginationRange?.map((pageNumber, idx) => {
        ...
        if (typeof pageNumber !== 'number') {
          return (
            <div className="text-slate-400 dark:text-slate-500" key={idx}>
              &#8230;
            </div>
          )
        }
...
/** Hook that computes the visible page number range with optional dot separators. */
