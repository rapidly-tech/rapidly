...
describe('CustomerPortalProvider', () => {
  ...
  it('provides context values', () => {
    ...
    expect(result.current.workspaceId).toBe('org_123')
    expect(result.current.workspaceSlug).toBe('test-org')
  ...
  it('provides a portal client with correct config', () => {
    ...
    expect(result.current.client.config.workspaceId).toBe('org_123')
  })
})
