...
describe('RapidlyCustomerPortalError', () => {
  it('creates error with all properties', () => {
    const error = new RapidlyCustomerPortalError({
    ...
    expect(error.name).toBe('RapidlyCustomerPortalError')
  })
  ...
  it('extends Error', () => {
    ...
    expect(error).toBeInstanceOf(RapidlyCustomerPortalError)
  })
  ...
  describe('fromResponse', () => {
    it('creates error from API response with string detail', () => {
      ...
      const error = RapidlyCustomerPortalError.fromResponse(apiError, response)
...
describe('UnauthorizedError', () => {
  ...
  it('extends RapidlyCustomerPortalError', () => {
    const error = new UnauthorizedError()
...
describe('isValidationError', () => {
  ...
  it('returns false for other errors', () => {
    ...
    expect(
      isValidationError(
        new RapidlyCustomerPortalError({
          message: 'test',
          code: 'test',
          status: 400,
        }),
