...
- **Use Sandbox Environment**: All testing must be conducted using our sandbox environment. Want to test in production? Use a free share to avoid using real money.
...
- **Consequences of High Chargeback Rates**:
  ...
  <Note>
    We also have integrations with credit card networks to receive early chargeback signals before they're officially filed. We automatically refund such transactions under a certain value and revoke any file share access associated with the customer to reduce chargebacks proactively.
  </Note>
