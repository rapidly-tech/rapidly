"""Tests for the Rapidly image-resizer Lambda handler.

Exercises snap_to_size rounding, image-extension detection, resize logic,
S3 cache-hit / cache-miss paths, error handling, and URL-encoded key
support.  Uses moto to mock AWS S3 in-process.
"""
