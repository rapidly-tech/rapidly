"""Rapidly test event ingestion script.

CLI tool for sending synthetic usage events to the Rapidly event ingestion
API. Useful for populating a development environment with realistic event
data for testing metering and billing flows.
"""
