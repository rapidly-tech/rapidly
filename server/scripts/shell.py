...
from rapidly import workers  # noqa: F401
...
>>> stmt = customer_repository.get_base_statement().where(Customer.email == 'test+customer045@rapidly.tech')
...
def start_shell() -> None:
    rich.print("""
[bold cyan]Welcome to the Rapidly shell![/bold cyan]
