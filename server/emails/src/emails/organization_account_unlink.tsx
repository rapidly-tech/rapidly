  ...
  return (
    <WrapperRapidly>
      ...
      <Intro>
        ...
        associated with organizations in Rapidly have been detached. This update
            ...
            <ul className="ml-4 list-disc p-0">
              {organizations_unlinked.map((org: string) => (
                <li key={org} className="mt-2">
                  ...
                  <Link
                    href={`https://rapidly.tech/dashboard/${org}/finance/account`}
                  >
                    https://rapidly.tech/dashboard/{org}/finance/account
                  </Link>
                </li>
              ))}
            </ul>
