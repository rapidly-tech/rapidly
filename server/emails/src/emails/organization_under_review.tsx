    ...
    <WrapperRapidly>
      ...
      <Section>
        <BodyText>
          ...
          when joining Rapidly. As a file sharing platform, we need to ensure
        ...
        <BodyText>
          ...
          and integrate Rapidly. We&apos;ll notify you as soon as the review is
          complete.
        </BodyText>
        <BodyText>
          <Button href="https://rapidly.tech/docs/account-reviews">
