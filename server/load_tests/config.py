...
- LOAD_TEST_API_TOKEN: Workspace access token (rapidly_oat_*) for authenticated requests
...
class LoadTestConfig:
    ...
    share_id: str | None = os.getenv("LOAD_TEST_PRODUCT_ID")
    customer_email: str = os.getenv(
        "LOAD_TEST_CUSTOMER_EMAIL", "petru+loadtest@rapidly.tech"
    )
