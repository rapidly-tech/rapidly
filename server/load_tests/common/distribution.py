"""Rapidly load test distribution helpers.

Implements power-law probability distributions that mirror observed
Rapidly production traffic patterns, used to realistically distribute
simulated load across customer IDs during stress testing.
"""
