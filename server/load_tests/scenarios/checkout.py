"""Rapidly checkout flow load test scenarios.

Contains Locust user classes that simulate end-to-end checkout and
payment processing flows against the Rapidly API. Exercises the full
lifecycle: session creation, customer detail updates, status polling,
...
class CheckoutFlowTaskSet(SequentialTaskSet):
    ...
    def confirm_checkout(self):
        ...
        try:
            # Generate confirmation data for free share
