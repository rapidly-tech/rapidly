"""Settings section with workspace configuration."""
        ...
        with tag.div(classes="space-y-6"):
            ...
            with card(bordered=True):
                with tag.div(classes="flex items-center justify-between mb-4"):
                    ...
                    with button(
                        ...
                        hx_get=str(
                            request.url_for(
                                "workspaces-v2:edit", workspace_id=self.org.id
                            )
                        ),
                        hx_target="#modal",
                    ):
            ...
            with card(bordered=True):
                ...
                with tag.div(classes="space-y-2"):
                    # Import WorkspaceFeatureSettings to iterate over feature flags
