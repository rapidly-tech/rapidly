...
This guide covers everything you need to know to create and maintain backoffice pages for the Rapidly billing platform.
...
```bash
mkdir rapidly/backoffice/my_entity
touch rapidly/backoffice/my_entity/__init__.py
touch rapidly/backoffice/my_entity/endpoints.py
touch rapidly/backoffice/my_entity/forms.py  # Optional
```
...
from rapidly.kit.pagination import PaginationParamsQuery
from rapidly.models import MyEntity
from rapidly.my_entity.repository import MyEntityRepository
from rapidly.my_entity.sorting import MyEntitySortProperty
