"""Project-view persistence layer."""
...
from rapidly.models import Project, ProjectView, WorkspaceMembership
...
class ProjectViewRepository(
    ...
    async def get_by_name(self, project_id: UUID, name: str) -> ProjectView | None:
