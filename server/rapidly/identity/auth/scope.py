...
class Scope(StrEnum):
    ...
    work_item_attachments_read = "work_item_attachments:read"
    work_item_attachments_write = "work_item_attachments:write"
...
SCOPES_SUPPORTED_DISPLAY_NAMES: dict[Scope, str] = {
    ...
    Scope.work_item_attachments_read: "Read work item attachments",
    Scope.work_item_attachments_write: "Create or modify work item attachments",
