...
class Scope(StrEnum):
    ...
    stickies_read = "stickies:read"
    stickies_write = "stickies:write"
...
SCOPES_SUPPORTED_DISPLAY_NAMES: dict[Scope, str] = {
    ...
    Scope.stickies_read: "Read your sticky notes",
    Scope.stickies_write: "Create or modify your sticky notes",
