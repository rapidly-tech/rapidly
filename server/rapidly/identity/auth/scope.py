...
class Scope(StrEnum):
    ...
    work_item_reactions_read = "work_item_reactions:read"
    work_item_reactions_write = "work_item_reactions:write"
...
SCOPES_SUPPORTED_DISPLAY_NAMES: dict[Scope, str] = {
    ...
    Scope.work_item_reactions_read: "Read emoji reactions on work items and comments",
    Scope.work_item_reactions_write: "Add or remove emoji reactions",
