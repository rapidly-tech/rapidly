...
class Scope(StrEnum):
    ...
    work_item_subscribers_read = "work_item_subscribers:read"
    work_item_subscribers_write = "work_item_subscribers:write"
...
SCOPES_SUPPORTED_DISPLAY_NAMES: dict[Scope, str] = {
    ...
    Scope.work_item_subscribers_read: "Read work item subscribers",
    Scope.work_item_subscribers_write: "Subscribe or unsubscribe from work items",
