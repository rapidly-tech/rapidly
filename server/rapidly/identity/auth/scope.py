...
class Scope(StrEnum):
    ...
    recent_visits_read = "recent_visits:read"
    recent_visits_write = "recent_visits:write"
...
SCOPES_SUPPORTED_DISPLAY_NAMES: dict[Scope, str] = {
    ...
    Scope.recent_visits_read: "Read your recently visited items",
    Scope.recent_visits_write: "Record or clear recently visited items",
