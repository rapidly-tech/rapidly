"""Pydantic schemas for member session requests and responses."""
...
from rapidly.identity.member.types import Member
...
class MemberSession(IdentifiableSchema, AuditableSchema):
    """
