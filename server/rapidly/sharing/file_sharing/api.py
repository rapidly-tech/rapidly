...
async def fetch_secret(
    ...
    payment_token = x_payment_token or http_request.cookies.get("rapidly_spt")
...
async def create_channel(
    ...
    return await file_sharing_service.create_channel(
        redis=redis,
...
async def fetch_channel(
    ...
    # Accept payment token from header OR httpOnly cookie
    effective_payment_token = x_payment_token or http_request.cookies.get("rapidly_pt")
