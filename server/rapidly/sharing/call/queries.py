"""Redis queries for the Call chamber.

Reuses ``ChannelRepository`` for channel-backed state; adds the invite
token SET specific to Call. One new Redis key prefix:
...
_INVITE_SET_KEY = "file-sharing:call:invite:{slug}"
...
def _hash_invite_token(raw_token: str) -> str:
    """SHA-256 hash, same scheme Screen and Watch use."""
