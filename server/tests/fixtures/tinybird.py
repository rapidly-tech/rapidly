"""Tinybird workspace provisioning and client fixtures for integration tests."""
...
from rapidly.integrations.tinybird import actions as tinybird_service
...
def tinybird_workspace() -> Generator[str, None, None]:
    ...
    if shutil.which("tb") is None:
        pytest.skip("Tinybird CLI ('tb') not installed")
