"""Tests for GitHub secret scanning alert handling."""
...
from rapidly.integrations.github.actions.secret_scanning import InvalidSignature
from rapidly.integrations.github.actions.secret_scanning import (
...
class TestVerifySignature:
    async def test_invalid_signature(self, mocker: MockerFixture) -> None:
        mocker.patch.object(
            secret_scanning_service, "_fetch_public_key", return_value=public_key_pem
        )
        ...
        [
            pytest.param(
                [
                    {
                        "token": "TOKEN",
                        "type": "rapidly_workspace_access_token",
                        "source": "github",
                    },
                    {
                        "token": "TOKEN",
                        "type": "rapidly_client_secret",
                        "source": "github",
