...
State, Secrets and Runs are directly managed on [HCP Terraform Cloud](https://app.terraform.io/app/rapidly-tech/workspaces/rapidly).
...
resource "render_env_group" "backend_production" {
  ...
  env_vars = {
    # ...
    RAPIDLY_MY_VARIABLE = { value = var.my_variable }
  }
  # ...
}
```
